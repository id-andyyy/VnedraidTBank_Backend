...
main_router.include_router(tradingview_router, prefix="/api/tradingview", tags=["TradingView 📈"])
main_router.include_router(parsers_router, prefix="/api/parsers", tags=["Parsers ⚙️"])
